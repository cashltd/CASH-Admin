<table width="100%" border="0" class="verifytable" cellpadding="0" cellspacing="0">
	...
	{foreach from=$data item=item}
		<tr bgcolor="{cycle values="white,#ebebeb"}">
			...
			<td valign="center" width="120" align="center">{$item.accepted|date_format:"%d/%m/%y - %R"}</td>
			<TD valign="center" width="190" align="center">{$item.csv}</td>
	...
	<tr>
		...
		<th colspan="4" align="left">Currently on Page {$pagenumber}</th>
