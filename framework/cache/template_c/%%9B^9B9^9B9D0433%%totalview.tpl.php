<?php /* Smarty version 2.6.14, created on 2012-02-14 16:50:55
         compiled from claimants/totalview.tpl */ ?>
<script>
<?php echo '
...
<?php echo '
	...
	function freshchange(type) {
		...
		claimp.stop();
		claimp.url = \'';  echo $this->_tpl_vars['HomeUrl'];  echo 'ajax/claimants_freshdata/id/\'+provider+\'-\'+freshpagestart+\'-\'+perpage+\'-\'+userid+\'/\';
		claimp.start();
	...
	function declinechange(type) {
		...
		claimr.stop();
		claimr.url = \'';  echo $this->_tpl_vars['HomeUrl'];  echo 'ajax/claimants_olddata/id/\'+provider+\'-\'+declinepagestart+\'-\'+perpage+\'-\'+userid+\'/\';
		claimr.start();
	...
	function acceptchange(type) {
		...
		claimq.stop();
		claimq.url = \'';  echo $this->_tpl_vars['HomeUrl'];  echo 'ajax/claimants_newdata/id/\'+provider+\'-\'+acceptpagestart+\'-\'+perpage+\'-\'+userid+\'/\';
		claimq.start();
...
<?php echo ' 
// <![CDATA[
var claimp = new Ajax.PeriodicalUpdater(\'toVerify\', \'';  echo $this->_tpl_vars['HomeUrl'];  echo 'ajax/claimants_freshdata/id/\'+provider+\'-\'+freshpagestart+\'-\'+perpage+\'-\'+userid+\'/\', {
...
<?php echo ' 
// <![CDATA[
var claimq = new Ajax.PeriodicalUpdater(\'claimQueue\', \'';  echo $this->_tpl_vars['HomeUrl'];  echo 'ajax/claimants_newdata/id/\'+provider+\'-\'+acceptpagestart+\'-\'+perpage+\'-\'+userid+\'/\', {
  method: \'get\', frequency: 30});
// ]]>
'; ?>
...
<?php echo ' 
// <![CDATA[
var claimr = new Ajax.PeriodicalUpdater(\'noVerify\', \'';  echo $this->_tpl_vars['HomeUrl'];  echo 'ajax/claimants_olddata/id/\'+provider+\'-\'+declinepagestart+\'-\'+perpage+\'-\'+userid+\'/\', {
  method: \'get\', frequency: 30});
// ]]>
'; ?>
