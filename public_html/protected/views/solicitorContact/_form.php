...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'firm_id', CHtml::listData(SolicitorFirm::model()->findAll(), 'id', 'title'), array('prompt'=>'Select Solicitor Firm')); ?>
